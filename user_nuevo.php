                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form" method="POST" action="php/new_user.php" enctype="multipart/form-data">
                            ...
                            <input type="file" class="form-control" id="add-new-photo" name="fotos">
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="user" value="root" placeholder="Escriba su nombre">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Apellido</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="apellido" value="afsf" placeholder="Escriba su apellido">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Correo</label>
                                        <div class="col-10">
                                            <input class="form-control" type="email" name="email" value="asfsd@mail.com" placeholder="Escriba su correo">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Password</label>
                                        <div class="col-10">
                                            <input class="form-control" type="password" name="password" value="gwdew" required>
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
