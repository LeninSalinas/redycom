                                    ...
                                    <div class="table-responsive m-t-40">
                                        <div id="example23_wrapper" class="dataTables_wrapper">
                                            ...
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting_asc" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Marca: activate to sort column descending" style="width: 129px;">ID</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Modelos: activate to sort column ascending" style="width: 194px;">NOMBRE</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Rol: activate to sort column ascending" style="width: 96px;">UBICACION</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Modelos: activate to sort column ascending" style="width: 194px;">TELEFONO</th>
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1" aria-label="Rol: activate to sort column ascending" style="width: 96px;">ACCIONES</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php
                                                            echo $row['id_sucursal'];//aqui van a ir los datos de la tabla 
                                                            ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['nombre_suc'];//aqui van a ir los datos de la tabla
                                                            ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['ubicacion_suc'];//aqui van a ir los datos de la tabla
                                                            ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['telefono_suc'];//aqui van a ir los datos de la tabla
                                                            ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['estado_suc'];//aqui van a ir los datos de la tabla
                                                            ?>
                                                        </td>
